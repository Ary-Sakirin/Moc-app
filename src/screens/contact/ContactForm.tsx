        ...
        <>
            <div className="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                <div className="text-center mb-5 ">
                    <div className="feature bg-primary bg-gradient text-white rounded-3 m-auto mb-3 icon-title-contact"><i className="bi bi-envelope"></i></div>
                    ...
                    <div className="col-lg-8 col-xl-6">
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div className="form-floating mb-3">
                                ...
                                id="message" placeholder="Enter your message here..." data-sb-validations="required" data-sb-can-submit="no"></textarea>
